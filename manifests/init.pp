...
#
# $server_ssl_verify_client::   Defines the Apache mod_ssl SSLVerifyClient directive in Foreman vhost conf file.
#
...
class foreman (
  ...
  Optional[String] $server_ssl_verify_client = $::foreman::params::server_ssl_verify_client,
